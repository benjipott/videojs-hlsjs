...
(function (window, videojs, Hls, document, undefined) {
  ...
  var Hlsjs = videojs.extend(Html5, {
    createEl: function () {
      ...
      this.hls_.on(Hls.Events.FRAG_PARSING_DATA, this.onFragParsingData);
    ...
    onFragParsingData: function (event, data) {
      var player_ = videojs.getPlayers()[Object.keys(videojs.getPlayers())];
      player_.trigger("fragMoovDataParsed", data);
    },
      ...
      if (data.fatal) {
        switch (data.type) {
          ...
          case Hls.ErrorTypes.MEDIA_ERROR:
            ...
            /*
             * should call swapAudioCodec to recoverMediaError
